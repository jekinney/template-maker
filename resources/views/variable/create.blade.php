                ...
                <div class="panel-body">
                  <form action="{{ route('variable.store') }}" method="post">
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Residents Name">
                      @if ($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="description" id="description" value="{{ old('description') }}" class="form-control" placeholder="Variable to insert a residents name.">
                    ...
                    <div class="form-group {{ $errors->has('variable') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="variable" id="variable" value="{{ old('variable') }}" class="form-control" placeholder="res_name"/>
                    ...
                    <div class="form-group {{ $errors->has('test_data') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="test_data" id="test_data" value="{{ old('test_data') }}" class="form-control" placeholder="John Doe"/>
